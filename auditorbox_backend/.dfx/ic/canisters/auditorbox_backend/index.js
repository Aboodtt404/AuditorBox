...
import { idlFactory } from './auditorbox_backend.did.js';
export { idlFactory } from './auditorbox_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUDITORBOX_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auditorbox_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auditorbox_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auditorbox_backend.did.js")._SERVICE>}
 */
export const auditorbox_backend = createActor(canisterId);
