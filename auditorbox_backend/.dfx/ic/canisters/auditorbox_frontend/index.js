...
import { idlFactory } from './auditorbox_frontend.did.js';
export { idlFactory } from './auditorbox_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUDITORBOX_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auditorbox_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auditorbox_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auditorbox_frontend.did.js")._SERVICE>}
 */
export const auditorbox_frontend = createActor(canisterId);
