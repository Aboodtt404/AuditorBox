// Adjustment page — auto-generated from .did
// Generated: 2026-02-08T19:16:01.410329
...
export const AdjustmentPage: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (args: any) => api.createAdjustment(args),
    onSuccess: () => qc.invalidateQueries(),
  });

  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">Adjustment</h2>
